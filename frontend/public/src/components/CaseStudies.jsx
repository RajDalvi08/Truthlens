    ...
    <div className="max-w-6xl mx-auto space-y-16 animate-in fade-in duration-1000 pb-32 mesh-bg">
        <motion.div variants={containerVariants} initial="hidden" animate="visible" className="space-y-16 relative z-10 pt-16">
          <div className="text-center pb-12 border-b border-[#fdf8f5]/10">
            <h1 className="text-6xl md:text-7xl font-black text-[#fdf8f5] tracking-tighter uppercase italic leading-[0.85]">Case Studies</h1>
            <p className="text-[#8d7b68] mt-8 leading-relaxed max-w-2xl mx-auto font-black uppercase tracking-[0.2em] text-[11px] italic underline decoration-[#fdf8f5]/10 leading-relaxed">Examples of how we detect bias across global news.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 pb-20">
            {cases.map((c) => (
              ...
              >
                ...
                <span className="text-[9px] font-black text-[#4d3c2e] uppercase tracking-[0.3em] mb-4 block italic">Analysis_{c.id}</span>
