        ...
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
            {accountList.map((acc) => (
              ...
              >
                ...
                {acc.active && (
                  <span className="mt-4 px-3 py-1 bg-[#fdf8f5] text-[#1a0f0a] text-[8px] font-black uppercase tracking-widest italic">
                    ACTIVE NODE
                  </span>
                )}
          ...
          <div className="mt-20 text-center flex flex-col items-center">
            ...
            >
              ...
              <form className="space-y-10 relative z-10" onSubmit={handleAddIdentity}>
