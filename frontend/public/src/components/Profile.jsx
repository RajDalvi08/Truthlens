...
import { HiOutlineUser, HiOutlineLightningBolt, HiOutlineShieldCheck, HiOutlineTrendingUp, HiOutlineBadgeCheck, HiOutlineCog } from "react-icons/hi";
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-center gap-16">
           ...
           <div className="flex-1 text-center md:text-left">
              <div className="flex flex-col md:flex-row md:items-center gap-6">
                  <h1 className="text-5xl font-black text-[#fdf8f5] tracking-tighter uppercase italic drop-shadow-2xl">creative_ambition</h1>
                  <HiOutlineBadgeCheck className="w-10 h-10 text-[#fdf8f5] hidden md:block opacity-80" />
              </div>
              <div className="flex flex-wrap justify-center md:justify-start gap-6 mt-6">
                  <span className="px-5 py-2 bg-[#fdf8f5]/10 text-[#fdf8f5] border border-[#fdf8f5]/20 text-[10px] font-black uppercase tracking-[0.3em] italic shadow-xl">Level 42 Analyst Protocol</span>
              ...
              <div className="flex flex-wrap justify-center md:justify-start gap-6 mt-12">
                  <button className="px-12 py-5 text-[11px] font-black uppercase tracking-[0.3em] bg-[#fdf8f5] text-[#1a0f0a] hover:bg-[#f5ebe0] border-none rounded-none italic shadow-2xl transition-all">Update Identity Params</button>
