            ...
            <div className="grid grid-cols-2 gap-6">
              <div>
                ...
                <input
                  ...
                  className="w-full px-6 py-4 bg-[#1a0f0a] border border-[#fdf8f5]/10 rounded-none text-xs font-black uppercase tracking-widest focus:border-[#fdf8f5] outline-none transition-all text-[#fdf8f5] placeholder:text-[#4d3c2e] italic"
                  placeholder="••••••••"
                />
              </div>
              <div>
