  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      addNotification({
        ...
        message: `Analysis completed with bias score ${response.bias_score}/100 (${response.bias_level}).`,
        type: "success"
      });
    } catch (err) {
      const errMsg = err?.message || "Failed to analyze the article. Please check your inputs and try again.";
      setError(errMsg);
      addNotification({
