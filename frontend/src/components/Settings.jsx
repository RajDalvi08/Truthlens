    ...
    <div className="max-w-4xl mx-auto space-y-12 animate-in fade-in duration-1000 pb-24 mesh-bg">
      ...
      <div className="border-b border-[#fdf8f5]/10 pb-12 flex flex-col md:flex-row md:items-end justify-between gap-8">
        <div>
          ...
          <p className="text-[#8d7b68] text-[10px] mt-4 font-black uppercase tracking-[0.25em] italic underline decoration-[#fdf8f5]/10">
        ...
        <div className="flex items-center gap-4">
          <button
            ...
            className="btn-primary px-8 py-4 text-[10px] flex items-center gap-3 italic shadow-2xl"
          >
            {savedStatus ? (
              <>
          ...
          >
              ...
              <div className="p-10 space-y-8">
                  <div 
                    ...
                    className="flex items-center justify-between p-8 glass-card bg-[#fdf8f5]/[0.02] border-[#fdf8f5]/5 rounded-none shadow-xl hover:border-[#fdf8f5]/20 transition-all cursor-pointer group"
                  >
                      <div>
                      ...
                      <div className={`w-16 h-8 rounded-none relative transition-all shadow-[0_0_20px_rgba(253,248,245,0.4)] ${
                        highFidelity ? "bg-[#fdf8f5]" : "bg-[#fdf8f5]/10 border border-[#fdf8f5]/20"
                      }`}>
                          <div className={`w-6 h-6 rounded-none absolute top-1 transition-all ${
                  ...
                  <div 
                    ...
                    className="flex items-center justify-between p-8 glass-card bg-[#fdf8f5]/[0.01] border-[#fdf8f5]/5 rounded-none hover:border-[#fdf8f5]/20 transition-all cursor-pointer group"
                  >
                      <div>
                          <p className="text-lg font-black text-[#fdf8f5] uppercase italic tracking-tighter group-hover:translate-x-2 transition-transform">Live Ingestion Ticker</p>
                      ...
                      <div className={`w-16 h-8 rounded-none relative transition-all ${
              ...
              <div className="p-10 space-y-12">
                  <div className="space-y-6">
                      ...
                      <div className="relative group">
                        <select 
                          ...
                          className="w-full appearance-none bg-[#1a0f0a] border border-[#fdf8f5]/10 text-[#fdf8f5] px-8 py-5 text-xs font-black uppercase tracking-[0.25em] italic rounded-none outline-none focus:border-[#fdf8f5] transition-all cursor-pointer shadow-xl"
                        >
                  ...
                  <div className="space-y-8">
                      <div className="flex justify-between items-end">
                         ...
                         <span className="text-[11px] font-black text-[#fdf8f5] bg-[#fdf8f5]/10 border border-[#fdf8f5]/20 px-4 py-2 italic uppercase tracking-[0.25em] shadow-xl">
          ...
          >
              <div className="saas-card p-12 flex flex-col justify-between bg-[#261a14]/60 border-[#fdf8f5]/10 rounded-none group hover:border-[#fdf8f5]/40 transition-all shadow-2xl relative overflow-hidden">
                  ...
                  <button 
                    ...
                    className="w-full py-5 text-[10px] font-black uppercase tracking-[0.3em] bg-[#1a0f0a] border border-[#fdf8f5]/10 text-[#8d7b68] hover:text-[#fdf8f5] hover:border-[#fdf8f5] hover:bg-[#fdf8f5]/10 transition-all rounded-none italic shadow-xl"
                  >
