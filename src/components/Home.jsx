...
function Home() {
  ...
  const handleViewDemo = () => {
    // Navigate to the '/demo' route (adjust based on your routes)
    navigate("/demo");
  };
        ...
        <div className="relative z-10 h-full flex items-center px-16">
          <div className="max-w-2xl space-y-6">
            ...
            <div className="flex space-x-4 mt-4">
              ...
              {/* View Demo Button with onClick event */}
              <button
                onClick={handleViewDemo}
                className="px-6 py-3 bg-transparent text-[#A89A84] border-2 border-[#A89A84] rounded-lg hover:bg-[#A89A84] hover:text-black transition shadow-md"
              >
                View Demo
              </button>
            </div>
