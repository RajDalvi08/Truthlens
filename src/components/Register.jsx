...
export default function Register() {
  ...
  return (
    <div className="min-h-screen bg-[var(--bg-primary)] flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_bottom_left,_var(--tw-gradient-stops))] from-fuchsia-900/20 via-transparent to-transparent pointer-events-none"></div>
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,_var(--tw-gradient-stops))] from-purple-900/15 via-transparent to-transparent pointer-events-none"></div>
      ...
      >
        ...
        <div className="bg-[var(--bg-secondary)]/80 backdrop-blur-xl border border-white/10 rounded-3xl p-8 shadow-[0_20px_60px_rgba(0,0,0,0.5)] relative overflow-hidden">
          ...
          <h2 className="text-2xl font-black text-white text-center mb-1">Create Identity</h2>
          <p className="text-gray-400 text-center text-sm mb-8">Initialize your neural analysis profile</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="block text-xs font-mono text-gray-400 uppercase tracking-widest mb-2">Full Name</label>
              <input
                type="text"
                value={fullName}
                ...
                required
                className="w-full bg-[var(--bg-input)] border border-white/10 rounded-xl px-4 py-3.5 text-white focus:outline-none focus:border-fuchsia-500 focus:ring-1 focus:ring-fuchsia-500 transition-all placeholder:text-gray-600 font-light"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                required
                className="w-full bg-[var(--bg-input)] border border-white/10 rounded-xl px-4 py-3.5 text-white focus:outline-none focus:border-fuchsia-500 focus:ring-1 focus:ring-fuchsia-500 transition-all placeholder:text-gray-600"
              />
            </div>

            <div>
              <label className="block text-xs font-mono text-gray-400 uppercase tracking-widest mb-2">Confirm Access Key</label>
              <input
                type="password"
            ...
            <motion.button
              type="submit"
              disabled={loading}
              whileHover={{ scale: 1.02, boxShadow: "0 0 25px rgba(217,70,239,0.4)" }}
              whileTap={{ scale: 0.98 }}
              className="w-full py-4 mt-2 bg-gradient-to-r from-fuchsia-600 to-purple-600 text-white font-bold rounded-xl shadow-lg relative overflow-hidden group disabled:opacity-50 disabled:cursor-not-allowed"
            >
              <span className="relative z-10">{loading ? "Initializing..." : "Create Identity"}</span>
